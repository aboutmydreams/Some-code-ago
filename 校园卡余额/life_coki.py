...
def get_coki(a,coki=None):#http://life.ccb.com/tran/WCCMainPlatV5?CCB_IBSVersion=V5&SERVLET_NAME=WCCMainPlatV5&isAjaxRequest=true&TXCODE=NYS101&CHOOSETYPE=1&REGION_CODE=360000&BILL_ITEM=05013
    ...
    real_cookii = str('WCCTC='+str(cookii['WCCTC'])+'; tranCCBIBS1='+str(tranCC['tranCCBIBS1'])+'; ccbcustomid=dfb0525b50673a81cCq2SQCw86heIkM43Ctj1518080032515NfpKjxfBIyspYangTXhY747f853056f4e1dd6231aee0b06042ca; ccbdatard=1; cityName=%E5%8D%97%E6%98%8C%E5%B8%82; cityCode=360100; bankName=%E6%B1%9F%E8%A5%BF%E7%9C%81%E5%88%86%E8%A1%8C; bankCode=360000000; cityCodeFlag=0; cityCodeCustId=; billcitycode=360100; BIGipServerccvcc_jt_197.1_80_web_pool='+str(cookii['BIGipServerccvcc_jt_197.1_80_web_pool'])+'; ticket=; cs_cid=; custName=; userType=; lastLoginTime=; JSESSIONID='+str(cookii['JSESSIONID'])+'; INFO='+str(cookii['INFO'])+'; tranFAVOR='+str(cookii['tranFAVOR']))
    #print(cookii)
    #print(real_cookii)
    return real_cookii
